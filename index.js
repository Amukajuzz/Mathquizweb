...
const translations = {
    en: {
        ...
        rulesTitle: "Rules of the Quiz",
        rule1: "1. You only have 15 seconds per each question.",
        rule2: "2. Once you choose your answer, you cannot select again.",
        rule3: "3. You cannot choose any options after the time is up.",
        rule4: "4. You cannot quit the Quiz while you are playing.",
        rule5: "5. Once you finish click \"Submit Score\" to enter the leaderboard.",
        giveUp: "Give Up",
        continue: "Continue",
        quizTitle: "Math Quiz",
    ...
    ru: {
        ...
        rulesTitle: "Правила Викторины",
        rule1: "1. У Вас есть только 15 секунд на каждый вопрос.",
        rule2: "2. После выбора ответа, выбрать другой нельзя.",
        rule3: "3. Вы не можете выбирать ответы после истечения времени.",
        rule4: "4. Вы не можете выходить из викторины во время игры.",
        rule5: "5. После окончания нажмите \"Отправить результат\", чтобы войти в таблицу лидеров.",
        giveUp: "Сдаться",
        continue: "Продолжить",
        quizTitle: "Математическая Викторина",
        timeRemaining: "Оставшееся Время",
        yourScore: "Ваш Счет",
        showResults: "Показать Результаты",
        highestScore: "Рекордный Счет:",
        congratulations: "Поздравляем! Вы завершили викторину",
        submitMyScore: "Отправить Счет",
        playAgain: "Ещё раз"
    }
};
...
document.addEventListener('DOMContentLoaded', () => {
    const savedLanguage = localStorage.getItem('selectedLanguage') || 'en'; // Получаем язык из localStorage или используем 'en' как значение по умолчанию
